...
import {AppBar, Avatar, ClickAwayListener, Icon, IconButton, Paper, Toolbar, Typography} from '@material-ui/core';
                            ...
                            <div className="flex flex-1 items-center">
                                ...
                                {state && selectedContact && (
                                    <React.Fragment>
                                        ...
                                        <Typography className="ml-16 text-16"
                                                    color="inherit">{selectedContact.name}</Typography>
                                    </React.Fragment>
                                )}
                            </div>
