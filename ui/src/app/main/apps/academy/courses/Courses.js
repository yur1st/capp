                                                ...
                                                <Card elevation={1} className="flex flex-col h-256">
                                                    ...
                                                    >
                                                        <Typography className="font-medium truncate"
                                                                    color="inherit">{category.label}</Typography>
                                                        <div className="flex items-center justify-center opacity-75">
                                                            <Icon className="text-20 mr-8" color="inherit">access_time</Icon>
                                                            <div className="text-16 whitespace-no-wrap">{course.length} min
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <CardContent
                                                        ...
                                                        <Typography
                                                            className="text-center text-16 font-400">{course.title}</Typography>
                                                        <Typography className="text-center text-13 font-600 mt-4"
                                                                    color="textSecondary">{course.updated}</Typography>
                                                    </CardContent>
                                                    <Divider/>
