        ...
        <Paper className="w-full rounded-8 shadow-none border-1">
            <div className="flex items-center justify-between pr-4 pl-16 pt-4">
                <div className="flex items-center">
                    ...
                    <Typography
                        className="text-16">{props.widget.locations[props.widget.currentLocation].name}</Typography>
                </div>
            ...
            <div className="flex items-center justify-center p-16 pb-32">
                <Icon className="meteocons text-40"
                      color="action">{props.widget.locations[props.widget.currentLocation].icon}</Icon>
                <Typography className="text-44 ml-16"
                            color="textSecondary">{props.widget.locations[props.widget.currentLocation].temp[props.widget.tempUnit]}</Typography>
            ...
            <div className="flex justify-between items-center p-16">
                <div className="flex items-center">
                    ...
                    <Typography
                        className="ml-4">{props.widget.locations[props.widget.currentLocation].windSpeed[props.widget.speedUnit]}</Typography>
                ...
                <div className="flex items-center">
                    ...
                    <Typography
                        className="ml-4">{props.widget.locations[props.widget.currentLocation].windDirection}</Typography>
                </div>

                <div className="flex items-center">
                    <Icon className="meteocons text-14" color="action">rainy</Icon>
                    <Typography
                        className="ml-4">{props.widget.locations[props.widget.currentLocation].rainProbability}</Typography>
                </div>
            </div>
            <Divider/>
