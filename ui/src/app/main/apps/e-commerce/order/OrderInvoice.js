                ...
                <Card className="w-xl mx-auto" elevation={0}>
                    ...
                    <CardContent className="p-88 print:p-0">
                        ...
                        <div className="mt-96">
                            ...
                            <Typography className="mb-24 print:mb-12" variant="body1">Please pay within 15 days. Thank
                                you for your business.</Typography>
                            ...
                            <div className="flex">
                                ...
                                <Typography className="font-medium mb-64" variant="caption" color="textSecondary">
                                    ...
                                    dolor. Quisque
                                    scelerisque lacus sed feugiat fermentum. Cras aliquet facilisis pellentesque. Nunc
                                    hendrerit
                                    quam at leo commodo, a suscipit tellus dapibus. Etiam at felis volutpat est mollis
                                    lacinia.
