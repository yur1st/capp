            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="my-24 italic" component="p" color="textSecondary">
                        ...
                        in <code>src/app/App.js</code>.
                    </Typography>

                    <Typography className="my-24 italic" component="p" color="textSecondary">
                        Important: We don't give you any backend code. We are demonstrating the usage
                        with <code>@fake-db</code> (which is works with https requests as real).
                    </Typography>
