...
const changelogData = [
    ...
    },
    {
        ...
        date: '2019-06-02',
        newChanges: [
            <span>All of the code migrated to <a href="https://reactjs.org/docs/hooks-intro.html" target="_blank"
                                                 rel="noopener noreferrer">the hooks</a> (New feature of react let you use state and other React features without writing a class.)</span>,
        ...
        breakingChanges: [
            ...
            <span>We have no longer support Internet Explorer by default. If you still need it, you can install <a
                ...
                target="_blank" rel="noopener noreferrer">react-app-polyfill</a> for to support.</span>,
        ],
        notes: (
    ...
    },
    {
        ...
        newChanges: [
            ...
            <span><a href="https://github.com/mui-org/material-ui/releases/tag/v1.0.0-rc.0" target="_blank"
                     rel="noopener noreferrer"> Checkout the breaking changes</a></span>,
