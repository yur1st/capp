                ...
                <div className="p-24 max-w-2xl">
                    ...
                    <Paper className="max-w-md my-16">
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell className="font-bold text-14">Authorization Role (auth)
                                        options</TableCell>
                                    <TableCell/>
                                </TableRow>
                            </TableHead>
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        adding <b>auth</b> property in <code>src/app/fuse-configs/NavigationConfig.js</code>.
                    </Typography>
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        <br/>You can group the configs and define authorization in
                        the <code>src/app/fuse-configs/routesConfig.js</code> file,
