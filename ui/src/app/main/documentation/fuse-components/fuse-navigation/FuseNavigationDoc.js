            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        Group,
                        Collapse, Item. and Divider. These items can be mixed and matched to create unique and complex
                        navigation layouts.
                    </Typography>
                    ...
                    <Typography
                        className="mt-32 p-8 rounded-4 bg-yellow-lightest border-1 border-yellow-dark text-black mb-8">Its
                        mandatory to give a unique id to all of your
                    ...
                    <Typography className="text-16 mb-8" component="h2">
                        Use <code>prependNavigationItem(<i>object</i>, <i>collapseId/groupId</i>?)</code> action to
                        prepend a navigation item into the navigation array.
                    </Typography>
                    ...
                    <Typography className="text-16 mb-8" component="h2">
                        Use <code>appendNavigationItem(<i>object</i>, <i>collapseId/groupId</i>?)</code> action to
                        append a navigation item into the navigation array.
                    </Typography>
