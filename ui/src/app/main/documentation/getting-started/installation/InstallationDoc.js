            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        scope of
                        this documentation. Also you won't need to actually use Node.js, it's only required for the
                        development process.
                    </Typography>
                    ...
                    <Typography className="my-16" component="div">
                        <ol>
                            <li className="mb-16">
                                ...
                                will find the Skeleton
                                Project <b>(Fuse-react-x.x.x-skeleton.zip)</b> along with the Demo
                                Project <b>(Fuse-react-x.x.x-demo.zip)</b>, PSD designs and a readme file.
                            </li>
                            <li className="mb-16">
                                Extract the contents of the zip file <b>(Fuse-react-x.x.x-skeleton.zip)</b> into a
                                folder that you will work within. For this documentation, we will
                                refer that
                                as "your work folder".
                            </li>
                            <li className="mb-16">
                                Open your favorite console application (Terminal, Command Prompt etc.), navigate into
                                your work folder, run the following command and wait for it to
                                finish:
                                ...
                                <Typography className="mt-16" component="p">
                                    ...
                                    Please continue to the <Link className="font-medium"
                                                                 to="/documentation/working-with-fuse-react/development">Working
                                    with Fuse React
                                    section</Link>.
                                </Typography>
                            </li>
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        <a href="http://support.withinpixels.com/github" target="_blank" rel="noreferrer noopener"
                           className="mx-4 font-bold">invitation form</a>.
                    </Typography>
