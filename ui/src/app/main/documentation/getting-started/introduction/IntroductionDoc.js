            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        entry level of React, Redux knowledge so you can find your way
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        <a href="https://www.google.com/design/spec/material-design/introduction.html" target="_blank"
                           rel="noreferrer noopener" className="ml-4 font-bold">
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        If you don't know what React is or don't know how
