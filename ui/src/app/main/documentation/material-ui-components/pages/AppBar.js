            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div">The <a
                        ...
                        and actions
                        related to the current screen. It’s used for branding, screen titles, navigation, and
                        actions.</Typography>
                    <Typography className="mb-16" component="div">It can transform into a contextual action bar or used
                        as a navbar.</Typography>
                    ...
                    /></Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">App Bar with a primary search
                        field</Typography>
                    ...
                    /></Typography>
                    <Typography className="text-24 mt-32 mb-8"
                                component="h3"><code>{`useScrollTrigger([options]) =&gt; trigger`}</code></Typography>
                    <Typography className="text-16 mt-32 mb-8" component="h4">Arguments</Typography>
                    <ol>
                        <li><Typography className="mb-16"
                                        component="div"><code>{`options`}</code> (<em>Object</em> [optional]):</Typography>
                            <ul>
                                <li><code>{`options.disableHysteresis`}</code> (<em>Boolean</em> [optional]): Defaults
                                    to <code>{`false`}</code>. Disable the hysteresis. Ignore the
                                    scroll direction when determining the <code>{`trigger`}</code> value.
                                </li>
                                <li><code>{`options.target`}</code> (<em>Node</em> [optional]): Defaults
                                    to <code>{`window`}</code>.
                                </li>
                                <li><code>{`options.threshold`}</code> (<em>Number</em> [optional]): Defaults
                                    to <code>{`100`}</code>. Change the <code>{`trigger`}</code> value
                    ...
                    <Typography className="mb-16" component="div"><code>{`trigger`}</code>: Does the scroll position
                        match the criteria?</Typography>
