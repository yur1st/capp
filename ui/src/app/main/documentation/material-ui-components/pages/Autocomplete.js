            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16"
                                component="div"> src="https://img.shields.io/github/stars/paypal/downshift.svg?style=social&label=Stars"
                        alt="stars/>
                    ...
                    <Typography className="mb-16" component="div">The last demo allow to clear the input and show a
                        number of options on focus.</Typography>
                    ...
                    <Typography className="mb-16"
                                component="div"> src="https://img.shields.io/github/stars/JedWatson/react-select.svg?style=social&label=Stars"
                        alt="stars/>
                    ...
                    <Typography className="mb-16"
                                component="div"> src="https://img.shields.io/github/stars/moroshko/react-autosuggest.svg?style=social&label=Stars"
                        alt="stars/>
