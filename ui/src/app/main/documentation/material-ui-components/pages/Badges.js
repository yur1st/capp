        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Badge generates a small badge to the top-right of its
                        child(ren).</Typography>

                    <Typography className="text-32 mt-32 mb-8" component="h2">Simple Badges</Typography>
                    <Typography className="mb-16" component="div">Examples of badges containing text, using primary and
                        secondary colors. The badge is applied to its
                        children.</Typography>
                    ...
                    <Typography className="mb-16" component="div">You can use the <code>{`max`}</code> property to cap
                        the value of the badge content.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">The <code>{`dot`}</code> property changes a badge into
                        a small dot. This can be used as a notification that
                    ...
                    <Typography className="mb-16" component="div">The visibility of badges can be controlled using
                        the <code>{`invisible`}</code> property.</Typography>
                    <Typography className="mb-16" component="div">The badge auto hides with badgeContent is zero. You
                        can override this with the <code>{`showZero`}</code> property.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
