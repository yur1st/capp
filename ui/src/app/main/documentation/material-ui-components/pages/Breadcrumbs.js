        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Breadcrumbs allow users to make selections from a range of
                        values.</Typography>
                    ...
                    <Typography className="mb-16" component="div">In the following examples, we are using two string
                        separators, and an SVG icon.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Be sure to add
                        a <code>{`aria-label`}</code> description on
                        the <code>{`Breadcrumbs`}</code> component.</Typography>
                    <Typography className="mb-16" component="div">The accessibility of this component relies
                        on:</Typography>
                    <ul>
                        <li>The set of links is structured using an ordered list (<code>{`&lt;ol&gt;`}</code> element).
                        </li>
                        <li>To prevent screen reader announcement of the visual separators between links, they are
                            hidden with <code>{`aria-hidden`}</code>.
                        </li>
                        <li>A nav element labeled with <code>{`aria-label`}</code> identifies the structure as a
                            breadcrumb trail and makes it a navigation landmark so that it is
                            easy to locate.
                        </li>
                    </ul>
