        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Buttons allow users to take actions, and make choices, with a
                        single tap.</Typography>

                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/buttons.html">Buttons</a> communicate actions that
                        users can take.
                    ...
                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/buttons.html#contained-button">Contained buttons</a>
                        are high-emphasis, distinguished by their use of elevation and fill.
                        They contain actions that are primary to your app.</Typography>
                    <Typography className="mb-16" component="div">The last example of this demo show how to use an
                    ...
                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/buttons.html#text-button">Text buttons</a>
                        are typically used for less-pronounced actions, including those located:</Typography>
                    <ul>
                        <li>In dialogs</li>
                        <li>In cards</li>
                    </ul>
                    <Typography className="mb-16" component="div">In cards, text buttons help maintain an emphasis on
                    ...
                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/buttons.html#outlined-button">Outlined buttons</a>
                    ...
                    <Typography className="mb-16" component="div">Outlined buttons are also a lower emphasis alternative
                        to contained buttons,
                    ...
                    <Typography className="mb-16" component="div">The ButtonGroup component can be used to group
                        outlined (the default) or contained buttons.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">ButtonGroup can also be used to create a split button.
                        The dropdown can change the button action (as in this
                    ...
                    <Typography className="mb-16" component="div">A <a
                        href="https://material.io/design/components/buttons-floating-action-button.html">floating action
                        button</a>
                        (FAB) performs the primary, or most common, action on a screen.
                        It appears in front of all screen content, typically as a circular shape with an icon in its
                        center.
                        FABs come in two types: regular, and extended.</Typography>
                    <Typography className="mb-16" component="div">Only use a FAB if it is the most suitable way to
                        present a screen’s primary action.</Typography>
                    <Typography className="mb-16" component="div">Only one floating action button is recommended per
                        screen to represent the most common action.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">The floating action button animates onto the screen as
                        an expanding piece of material, by default.</Typography>
                    <Typography className="mb-16" component="div">A floating action button that spans multiple lateral
                        screens (such as tabbed screens) should briefly disappear,
                        then reappear if its action changes.</Typography>
                    <Typography className="mb-16" component="div">The Zoom transition can be used to achieve this. Note
                        that since both the exiting and entering
                        animations are triggered at the same time, we use <code>{`enterDelay`}</code> to allow the
                        outgoing Floating Action Button&#39;s
                    ...
                    <Typography className="mb-16" component="div">Fancy larger or smaller buttons? Use
                        the <code>{`size`}</code> property.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Sometimes you might want to have icons for certain
                        button to enhance the UX of the application as we recognize
                        logos more easily than plain text. For example, if you have a delete button you can label it
                        with a dustbin icon.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Icon buttons are commonly found in app bars and
                        toolbars.</Typography>
                    <Typography className="mb-16" component="div">Icons are also appropriate for toggle buttons that
                        allow a single choice to be selected or
                    ...
                    <Typography className="mb-16" component="div">Here are some examples of customizing the component.
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">👑 If you are looking for inspiration, you can
                        check <a href="https://mui-treasury.com/components/button">MUI
                    ...
                    <Typography className="mb-16" component="div">The Text Buttons, Contained Buttons, Floating Action
                        Buttons and Icon Buttons are built on top of the same
                    ...
                    <Typography className="mb-16" component="div">One common use case is to use the button to trigger a
                        navigation to a new page.
                        The <code>{`ButtonBase`}</code> component provides a property to handle this use
                        case: <code>{`component`}</code>.
                        However for certain focus polyfills <code>{`ButtonBase`}</code> requires the DOM node of the
                        provided
                        ...
                        Given that a lot of our interactive components rely on <code>{`ButtonBase`}</code>, you should
                        be
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div"><em>Note: Creating the Button components is necessary
                        to prevent unexpected unmounting.
                        You can read more about it in our <a href="/guides/composition/#component-property">component
                            property guide</a>.</em></Typography>
