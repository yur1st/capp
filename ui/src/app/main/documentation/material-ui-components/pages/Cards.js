            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div">They should be easy to scan for relevant and
                        actionable information. Elements, like text and images, should be
                    ...
                    <Typography className="mb-16" component="div">Although cards can support multiple actions, UI
                        controls, and an overflow menu, use restraint and remember that
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">By default, we use the combination of
                        a <code>{`&lt;div&gt;`}</code> element and a <em>background image</em> to
                        display the media. It can be problematic in some situations. For instance, you might want to
                        display a video or a responsive image. Use
                    ...
                    /></Typography>
                    <blockquote>
                        <Typography className="mb-16" component="div">⚠️ When <code>{`component=&quot;img&quot;`}</code>,
                            CardMedia relies on <code>{`object-fit`}</code> for
                    ...
                    <Typography className="mb-16" component="div">Supplemental actions within the card are explicitly
                        called out using icons, text, and UI controls, typically
