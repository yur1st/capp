        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Checkboxes allow the user to select one or more items from a
                        set.</Typography>

                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/selection-controls.html#checkboxes">Checkboxes</a> can
                        be used to
                    ...
                    <Typography className="mb-16" component="div">If you have multiple options appearing in a list,
                        ...
                        If you have a single option, avoid using a checkbox and use an on/off switch
                        instead.</Typography>
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div"><code>{`Checkbox`}</code> can also be used with a
                        label description thanks to
                    ...
                    <Typography className="mb-16" component="div"><code>{`FormGroup`}</code> is a helpful wrapper used
                        to group selection controls components that provides an
