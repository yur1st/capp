        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Detect if a click event happened outside of an element. It
                        listens for clicks that occur somewhere in the
                        document.</Typography>
                    ...
                    <Typography className="mb-16" component="div">For instance, if you need to hide a menu dropdown when
                        people click anywhere else on your page:</Typography>
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">You can find a more advanced demo on the <a
                        href="/components/menus/#menulist-composition">menu documentation
