        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">The container centers your content horizontally. It's the most
                        basic layout element.</Typography>

                    <Typography className="mb-16" component="div">While containers can be nested, most layouts do not
                        require a nested container.</Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Fluid</Typography>
                    <Typography className="mb-16" component="div">A fluid container width is bounded by
                        that <code>{`maxWidth`}</code> property value.</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div">If you prefer to design for a fixed set of sizes
                        instead of trying to accommodate a fully fluid viewport, you can
