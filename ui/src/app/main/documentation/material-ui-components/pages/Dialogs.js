        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Dialogs inform users about a task and can contain critical
                        information, require decisions, or involve multiple
                        tasks.</Typography>

                    <Typography className="mb-16" component="div">A <a
                        href="https://material.io/design/components/dialogs.html">Dialog</a> is a type of <a
                        href="/components/modal/">modal</a> window that appears in front of app content to provide
                        critical information or ask for a decision. Dialogs disable all
                        app functionality when they appear, and remain on screen until confirmed, dismissed, or a
                        required action has been taken.</Typography>
                    <Typography className="mb-16" component="div">Dialogs are purposefully interruptive, so they should
                        be used sparingly.</Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Simple Dialogs</Typography>
                    <Typography className="mb-16" component="div">Simple dialogs can provide additional details or
                        actions about a list item.
                        For example, they can display avatars, icons, clarifying subtext, or orthogonal actions (such as
                        adding an account).</Typography>
                    ...
                    <ul>
                        ...
                        <li>Touching outside of the dialog, or pressing Back, cancels the action and closes the dialog
                        </li>
                    </ul>
                    ...
                    <Typography className="mb-16" component="div">Alerts are urgent interruptions, requiring
                        acknowledgement, that inform the user about a situation.</Typography>
                    ...
                    <Typography className="mb-16" component="div">Use title bar alerts only for high-risk situations,
                        such as the potential loss of connectivity.
                        Users should be able to understand the choices based on the title and button text
                        alone.</Typography>
                    <Typography className="mb-16" component="div">If a title is required:</Typography>
                    <ul>
                        <li>Use a clear question or statement with an explanation in the content area, such
                            as &quot;Erase USB storage?&quot;.
                        </li>
                    ...
                    <Typography className="mb-16" component="div">You can also swap out the transition, the next example
                        uses <code>{`Slide`}</code>.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Form dialogs allow users to fill out form fields
                        within a dialog.
                        For example, if your site prompts for potential subscribers to fill in their email address, they
                        can fill out the email field and
                    ...
                    <Typography className="mb-16" component="div">Here is an example of customizing the component. You
                        can learn more about this in the
                        <a href="/customization/components/">overrides documentation page</a>.</Typography>
                    <Typography className="mb-16" component="div">The dialog has a close button added to aide
                    ...
                    <Typography className="mb-16" component="div">You can set a dialog maximum width by using
                        the <code>{`maxWidth`}</code> enumerable in combination with
                        the <code>{`fullWidth`}</code> boolean.
                        When the <code>{`fullWidth`}</code> property is true, the dialog will adapt based on
                        the <code>{`maxWidth`}</code> value.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">You may make a dialog responsively full screen
                        using <code>{`withMobileDialog`}</code>. By
                        default, <code>{`withMobileDialog()(Dialog)`}</code> responsively full screens <em>at or
                            below</em> the <code>{`sm`}</code> <a
                            href="/customization/breakpoints/">screen size</a>. You can choose your own breakpoint for
                        example <code>{`xs`}</code> by passing
                    ...
                    <Typography className="mb-16" component="div">Confirmation dialogs require users to explicitly
                        confirm their choice before an option is committed.
                        For example, users can listen to multiple ringtones but only make a final selection upon
                        touching “OK”.</Typography>
                    <Typography className="mb-16" component="div">Touching “Cancel” in a confirmation dialog, or
                        pressing Back, cancels the action, discards any changes, and closes
                    ...
                    <Typography className="mb-16" component="div">Follow the <a href="/components/modal/#accessibility">Modal
                        accessibility section</a>.</Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Scrolling long content</Typography>
                    <Typography className="mb-16" component="div">When dialogs become too long for the user’s viewport
                        or device, they scroll.</Typography>
                    <ul>
                        <li><code>{`scroll=paper`}</code> the content of the dialog scrolls within the paper element.
                        </li>
                    ...
                    <Typography className="mb-16" component="div">You can create a draggable dialog by using <a
                        ...
                        To do so, you can pass the the imported <code>{`Draggable`}</code> component as
                        the <code>{`PaperComponent`}</code> of
                    ...
                    <Typography className="mb-16" component="div">Follow the <a href="/components/modal/#performance">Modal
                        performance section</a>.</Typography>
