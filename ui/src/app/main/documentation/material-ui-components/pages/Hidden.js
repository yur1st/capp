        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Quickly and responsively toggle the visibility value of
                        components and more with our hidden utilities.</Typography>

                    <Typography className="mb-16" component="div">All elements are visible unless <strong>they are
                        explicitly hidden</strong>.
                        To ease integration with Material-UI&#39;s <a href="/customization/breakpoints/">responsive
                            breakpoints</a>,
                        this component can be used to hide any content,
                        or you can use it in conjunction with our <a
                            href="/components/grid/"><code>{`Grid`}</code></a> component.</Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">How it works</Typography>
                    <Typography className="mb-16" component="div">Hidden works with a range of breakpoints
                        e.g. <code>{`xsUp`}</code> or <code>{`mdDown`}</code>, or one or more
                        breakpoints
...
`}
                    ...
                    <Typography className="mb-16" component="div">By default, the <code>{`js`}</code> implementation is
                        used, responsively hiding content based on using the <a
                            href="/customization/breakpoints/#withwidth"><code>{`withWidth()`}</code></a> higher-order
                        component that watches screen size.
                        This has the benefit of not rendering any content at all unless the breakpoint is
                        met.</Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">css</Typography>
                    <Typography className="mb-16" component="div">If you are using server-side rendering, you can
                        set <code>{`implementation=&quot;css&quot;`}</code> if you
                    ...
                    <Typography className="mb-16" component="div">Using any breakpoint <code>{`up`}</code> property, the
                        given <em>children</em> will be hidden <em>at or
                    ...
                    <Typography className="mb-16" component="div">Using any breakpoint <code>{`down`}</code> property,
                        the given <em>children</em> will be hidden <em>at or
                    ...
                    <Typography className="mb-16" component="div">Using the breakpoint <code>{`only`}</code> property,
                        the given <em>children</em> will be hidden <em>at</em> the
                        specified breakpoint(s).</Typography>
                    <Typography className="mb-16" component="div">The <code>{`only`}</code> property can be used in two
                        ways:</Typography>
                    <ul>
                    ...
                    <Typography className="mb-16" component="div">It is quite common to alter <code>{`Grid`}</code> at
                        different responsive breakpoints, and in many cases, you want
