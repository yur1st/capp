            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><a
                        ...
                        or images.
                        They are composed of items containing primary and supplemental actions, which are represented by
                        icons and text.</Typography>
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">The last item of the previous demo shows how you can
                        render a link:</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div">You can find a <a
                        href="/guides/composition/#react-router">demo with React Router following this section</a> of
                    ...
                    <Typography className="mb-16" component="div">You should change the list item alignment when
                        displaying 3 lines or more, set
                    ...
                    <Typography className="mb-16" component="div">The checkbox is the primary action and the state
                        indicator for the list item. The comment button is a secondary
                    ...
                    <Typography className="mb-16" component="div">This feature is relying on the CSS sticky positioning.
                        ...
                        the browsers we are supporting. We default
                    ...
                    <Typography className="mb-16" component="div">In the following example, we demonstrate how to use <a
                        href="https://github.com/bvaughn/react-window">react-window</a> with
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">We encourage the use of <a
                        href="https://github.com/bvaughn/react-window">react-window</a> when possible.
                        If this library doesn&#39;t cover your use case, you should consider using <a
                            href="https://github.com/bvaughn/react-virtualized">react-virtualized</a>,
                        then alternatives like <a
