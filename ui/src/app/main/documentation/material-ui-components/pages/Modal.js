        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">The modal component provides a solid foundation for creating
                        dialogs, popovers, lightboxes, or whatever else.</Typography>

                    <Typography className="mb-16" component="div">The component renders
                        its <code>{`children`}</code> node in front of a backdrop component.
                    ...
                    <blockquote>
                        <Typography className="mb-16" component="div"><strong>Terminology note</strong>. The
                            term &quot;modal&quot; is sometimes used to mean &quot;dialog&quot;,
                            but this is a misnomer.
                            A Modal window describes parts of a UI.
                            An element is considered modal if <a href="https://en.wikipedia.org/wiki/Modal_window">it
                                blocks interaction with the rest of the
                                application</a>.</Typography>
                    </blockquote>
                    <Typography className="mb-16" component="div">If you are creating a modal dialog, you probably want
                        to use the <a
                    ...
                    <Typography className="mb-16" component="div">The content of the modal is <strong>lazily
                        mounted</strong> into the DOM.
                        It ensures that having many closed modal in your React tree won&#39;t slow down your
                        page.</Typography>
                    <Typography className="mb-16" component="div">However, creating React elements has a cost too.
                        Consider the following case:</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div">We create a lot of React elements that will never be
                        mounted. It&#39;s wasteful 🐢.
...
`}
                    ...
                    <Typography className="mb-16" component="div">This way, you take advantage of <a
                        href="https://overreacted.io/react-as-a-ui-runtime/#lazy-evaluation">React
                    ...
                    <ul>
                        <li>Be sure to add <code>{`aria-labelledby=&quot;id...&quot;`}</code>, referencing the modal
                            title, to the <code>{`Modal`}</code>.
                            Additionally, you may give a description of your modal with
                            the <code>{`aria-describedby=&quot;id...&quot;`}</code> property on
                            the <code>{`Modal`}</code>.
                        </li>
                    </ul>
...
`}
                    ...
                    <ul>
                        <li>The <a href="https://www.w3.org/TR/wai-aria-practices/examples/dialog-modal/dialog.html">WAI-ARIA
                            Authoring Practices 1.1</a> can help you set the
