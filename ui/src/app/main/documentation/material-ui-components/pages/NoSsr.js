        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">NoSsr purposely removes components from the subject of Server
                        Side Rendering (SSR).</Typography>

                    <Typography className="mb-16" component="div">This component can be useful in a variety of
                    ...
                    <ul>
                        ...
                        <li>Improve the time-to-interactive by only rendering what&#39;s important (with
                            the <code>{`defer`}</code> property).
                        </li>
                    </ul>
                    ...
                    <Typography className="mb-16" component="div">In it&#39;s core, the NoSsr component purpose is
                        to <strong>defer rendering</strong>.
                        As it&#39;s illustrated in the previous demo, you can use it to defer the rendering from the
                        server to the client.</Typography>
                    <Typography className="mb-16" component="div">But you can also use it to defer the rendering within
                        the client itself.
                        You can <strong>wait a screen frame</strong> with the <code>{`defer`}</code> property to render
                        the children.
                        React does <a
                            href="https://reactjs.org/docs/strict-mode.html#detecting-unexpected-side-effects">2
                            commits</a> instead of 1.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
