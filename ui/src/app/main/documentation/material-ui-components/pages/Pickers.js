        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div">⚠️ Native input controls support by browsers <a
                        href="https://caniuse.com/#feat=input-datetime">isn&#39;t
                        perfect</a>.
                        Have a look at the <a href="#complementary-projects">complementary projects</a> for a richer
                        solution.</Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Date pickers</Typography>
                    <Typography className="mb-16" component="div">A native date picker example
                        with <code>{`type=&quot;date&quot;`}</code>.</Typography>
                    ...
                    <Typography className="mb-16" component="div">A native date &amp; time picker example
                        with <code>{`type=&quot;datetime-local&quot;`}</code>.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">A native time picker example
                        with <code>{`type=&quot;time&quot;`}</code>.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16"
                                component="div"> src="https://img.shields.io/github/stars/mui-org/material-ui-pickers.svg?style=social&label=Stars"
                        alt="stars/>
                    ...
                    <Typography className="mb-16" component="div"><a
                        href="https://material-ui-pickers.dev/">@material-ui/pickers</a> provides date and time controls
                        that follow
