        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">A Popover can be used to display some content on top of
                        another.</Typography>

                    <Typography className="mb-16" component="div">Things to know when using
                        the <code>{`Popover`}</code> component:</Typography>
                    <ul>
                        <li>The component is built on top of the <a
                            href="/components/modal/"><code>{`Modal`}</code></a> component.
                        </li>
                        <li>The scroll and click away are blocked unlike with the <a
                            href="/components/popper/"><code>{`Popper`}</code></a> component.
                        </li>
                    </ul>
                    ...
                    <Typography className="mb-16" component="div">Use the radio buttons to adjust
                        the <code>{`anchorOrigin`}</code> and <code>{`transformOrigin`}</code> positions.
                        You can also set
                        the <code>{`anchorReference`}</code> to <code>{`anchorPosition`}</code> or <code>{`anchorEl`}</code>.
                        When it is <code>{`anchorPosition`}</code>, the component will, instead
                        of <code>{`anchorEl`}</code>,
                    ...
                    <Typography className="mb-16" component="div">We demonstrate how to use
                        the <code>{`Popover`}</code> component to implement a popover behavior based on the
