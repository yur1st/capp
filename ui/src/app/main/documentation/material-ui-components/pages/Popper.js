        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">A Popper can be used to display some content on top of another.
                        It's an alternative to react-popper.</Typography>

                    <Typography className="mb-16" component="div">Some important features of
                        the <code>{`Popper`}</code> component:</Typography>
                    <ul>
                        <li>🕷 Popper relies on the 3rd party library (<a
                            href="https://github.com/FezVrasta/popper.js">Popper.js</a>) for perfect positioning.
                        </li>
                        ...
                        <li>The children is <a href="/components/portal/"><code>{`Portal`}</code></a> to the body of the
                            document to avoid rendering problems.
                            You can disable this behavior with <code>{`disablePortal`}</code>.
                        </li>
                        <li>The scroll isn&#39;t blocked like with the <a
                            href="/components/popover/"><code>{`Popover`}</code></a> component.
                            The placement of the popper updates with the available area in the viewport.
                        </li>
                        <li>Clicking away does not hide the <code>{`Popper`}</code> component.
                            If you need this behavior, you can use <a
                                href="/components/click-away-listener/"><code>{`ClickAwayListener`}</code></a> - see the
                            example in the <a
                                href="/components/menus/#menulist-composition">menu documentation section</a>.
                        </li>
                        <li>The <code>{`anchorEl`}</code> is passed as the reference object to create a
                            new <code>{`Popper.js`}</code> instance.
                        </li>
                    </ul>
                    ...
                    <Typography className="mb-16" component="div">You can use the component with zero extra
                    ...
                    <Typography className="mb-16" component="div">The <code>{`anchorEl`}</code> property can be a
                        reference to a fake DOM element.
                    ...
                    <Typography className="mb-16" component="div">Highlight part of the text to see the
                        popper:</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
