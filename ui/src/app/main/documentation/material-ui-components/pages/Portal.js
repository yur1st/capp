        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">The portal component renders its children into a new "subtree"
                        outside of current component hierarchy.</Typography>

                    <Typography className="mb-16" component="div">The children of the portal component will be appended
                        to the <code>{`container`}</code> specified.</Typography>
                    <Typography className="mb-16" component="div">The component is used internally by the <a
                        href="/components/modal/"><code>{`Modal`}</code></a> and <a
