        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Steppers convey progress through numbered steps. It provides a
                        wizard-like workflow.</Typography>

                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/archive/guidelines/components/steppers.html">Steppers</a> display
                        progress through a
                    ...
                    <blockquote>
                        <Typography className="mb-16" component="div"><strong>Note:</strong> Steppers are no longer
                            documented in the Material Design documentation.</Typography>
                    </blockquote>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Horizontal Linear</Typography>
                    <Typography className="mb-16" component="div">The <code>{`Stepper`}</code> can be controlled by
                        passing the current step index (zero-based) as
                        the <code>{`activeStep`}</code> property. <code>{`Stepper`}</code> orientation is set using
                        the <code>{`orientation`}</code> property.</Typography>
                    <Typography className="mb-16" component="div">This example also shows the use of an optional step by
                        placing the <code>{`optional`}</code> property on the
                        second <code>{`Step`}</code> component. Note that it&#39;s up to you to manage when an optional
                        step is skipped. Once you&#39;ve determined this for a
                        particular step you must set <code>{`completed={false}`}</code> to signify that even though the
                        active step index has gone beyond the optional step,
                    ...
                    <Typography className="mb-16" component="div">Non-linear steppers allow users to enter a multi-step
                        flow at any point.</Typography>
                    <Typography className="mb-16" component="div">This example is similar to the regular horizontal
                        stepper, except steps are no longer automatically set
                        to <code>{`disabled={true}`}</code> based on
                        the <code>{`activeStep`}</code> property.</Typography>
                    <Typography className="mb-16" component="div">We&#39;ve used the <code>{`StepButton`}</code> here to
                        demonstrate clickable step labels as well as setting
                    ...
                    /></Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Horizontal Linear - Alternative
                        Label</Typography>
                    <Typography className="mb-16" component="div">Labels can be placed below the step icon by setting
                        the <code>{`alternativeLabel`}</code> property on
                    ...
                    /></Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Horizontal Non Linear - Alternative
                        Label</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    /></Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Horizontal Non Linear - Error
                        Step</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">This component uses a
                        customized <code>{`StepConnector`}</code> element that changes border color based on
                    ...
                    <Typography className="mb-16" component="div">This component implements a compact stepper suitable
                        for a mobile device. See <a
                            href="https://material.io/archive/guidelines/components/steppers.html#steppers-types-of-steps">mobile
                            steps</a> for its inspiration.</Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Mobile Stepper - Text</Typography>
                    <Typography className="mb-16" component="div">This is essentially a back/next button positioned
                        correctly.
                        You must implement the textual description yourself, however, an example is provided below for
                    ...
                    /></Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Mobile Stepper - Text with Carousel
                        effect</Typography>
                    <Typography className="mb-16" component="div">This demo is very similar to the previous, the
                        difference is the usage of
                        <a href="https://github.com/oliviertassinari/react-swipeable-views">react-swipeable-views</a> to
                        make the transition of steps.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Use dots when the number of steps isn’t
                        large.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Use a progress bar when there are many steps, or if
                        there are steps that need to be inserted during the process
