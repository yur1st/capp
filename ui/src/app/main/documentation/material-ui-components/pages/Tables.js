        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Data tables display sets of data. They can be fully
                    ...
                    <Typography className="mb-16" component="div"><a
                        ...
                        that’s easy to scan, so that users can look for patterns and insights. They can be embedded in
                        primary content, such as cards.</Typography>
                    ...
                    <Typography className="mb-16" component="div">For accessibility, the first column is set to be
                        a <code>{`&lt;th&gt;`}</code> element, with
                        a <code>{`scope`}</code> of <code>{`&quot;row&quot;`}</code>. This enables screen readers to
                        identify a cell&#39;s value by it&#39;s row and column
                        name.</Typography>
                    ...
                    <Typography className="mb-16" component="div">A simple example of a dense table with no
                        frills.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">This example demonstrates the use
                        of <code>{`Checkbox`}</code> and clickable rows for selection, with a
                        custom <code>{`Toolbar`}</code>. It uses the <code>{`TableSortLabel`}</code> component to help
                        style column headings.</Typography>
                    <Typography className="mb-16" component="div">The Table has been given a fixed width to demonstrate
                        horizontal scrolling. In order to prevent the pagination
                        controls from scrolling, the TablePagination component is used outside of the Table. (The <a
                            href="#custom-table-pagination-action">&#39;Custom Table
                            Pagination Action&#39; example</a> below shows the pagination within the
                        TableFooter.)</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">The <code>{`Action`}</code> property of
                        the <code>{`TablePagination`}</code> component allows the implementation
                        of
                    ...
                    <Typography className="mb-16" component="div">A simple example with spanning
                        rows &amp; columns.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">In the following example, we demonstrate how to use <a
                        href="https://github.com/bvaughn/react-virtualized">react-virtualized</a> with
                    ...
                    <Typography className="mb-16"
                                component="div"> src="https://img.shields.io/github/stars/mbrn/material-table.svg?style=social&label=Stars"
                        alt="stars/>
                        src="https://img.shields.io/npm/dm/material-table.svg" alt="npm downloads/></Typography>
                    <Typography className="mb-16" component="div"><a
                        href="https://github.com/mbrn/material-table">material-table</a> is a simple and powerful
                        Datatable for React
                        based on Material-UI Table with some additional features.
                        They support many different use cases (editable, filtering, grouping, sorting, selection, i18n,
                        tree data and more). You should check it out.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <ul>
                        <li><a
                            href="https://devexpress.github.io/devextreme-reactive/react/grid/">dx-react-grid-material-ui</a> A
                            data grid for Material-UI with paging, sorting,
                            filtering, grouping and editing features (<a href="https://js.devexpress.com/licensing/">custom
                                license</a>).
                        </li>
                        <li><a href="https://github.com/gregnb/mui-datatables">mui-datatables</a> Responsive data tables
                            for Material-UI with filtering, sorting, search and more.
                        </li>
                    </ul>
