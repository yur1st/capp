        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Tabs make it easy to explore and switch between different
                        views.</Typography>

                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/tabs.html">Tabs</a> organize and allow navigation
                        between groups of
                    ...
                    <Typography className="mb-16" component="div">Long labels will automatically wrap on tabs. If the
                        label is too long for the tab, it will overflow and the text
                    ...
                    <Typography className="mb-16" component="div">A Tab can be disabled by
                        setting <code>{`disabled`}</code> property.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Fixed tabs should be used with a limited number of
                        tabs and when consistent placement will aid muscle
                        memory.</Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Full width</Typography>
                    <Typography className="mb-16"
                                component="div">The <code>{`variant=&quot;fullWidth&quot;`}</code> property should be
                        used for smaller views.
                        This demo also uses <a
                            href="https://github.com/oliviertassinari/react-swipeable-views">react-swipeable-views</a> to
                        animate the Tab transition, and
                    ...
                    <Typography className="mb-16" component="div">The <code>{`centered`}</code> property should be used
                        for larger views.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Left and right scroll buttons will automatically be
                        presented on desktop and hidden on mobile. (based on viewport
                        width)</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Left and right scroll buttons will be presented
                        regardless of the viewport width.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div">Left and right scroll buttons will never be presented.
                        All scrolling must be initiated through user agent
                    ...
                    <Typography className="mb-16" component="div">👑 If you are looking for inspiration, you can
                        check <a href="https://mui-treasury.com/components/tabs">MUI
                            Treasury&#39;s customization examples</a>.</Typography>
                    <Typography className="text-32 mt-32 mb-8" component="h2">Nav Tabs</Typography>
                    <Typography className="mb-16" component="div">By default tabs use a <code>{`button`}</code> element,
                        but you can provide your own custom tag or component.
                    ...
                    <Typography className="mb-16" component="div">Tab labels may be either all icons or all
                        text.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
