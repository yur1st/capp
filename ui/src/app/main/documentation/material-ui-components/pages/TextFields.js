            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="div"><a
                        href="https://material.io/design/components/text-fields.html">Text fields</a> allow users to
                        enter text into a
                    ...
                    <Typography className="mb-16" component="div">The <code>{`TextField`}</code> wrapper component is a
                        complete form control including a label, input and help
                        text.</Typography>
                    ...
                    /></Typography>
                    <blockquote>
                        <Typography className="mb-16" component="div"><strong>Note:</strong> This version of the text
                    ...
                    <Typography className="mb-16" component="div"><code>{`TextField`}</code> supports filled
                        styling.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div"><code>{`TextField`}</code> is composed of smaller
                        components (
                    ...
                    <Typography className="mb-16" component="div">You might also have noticed that some native HTML
                        input properties are missing from
                        the <code>{`TextField`}</code> component.
                        This is on purpose.
                        The component takes care of the most used properties, then it&#39;s up to the user to use the
                        underlying component shown in the following demo. Still, you
                        can
                        use <code>{`inputProps`}</code> (and <code>{`InputProps`}</code>, <code>{`InputLabelProps`}</code> properties)
                        if you want to avoid some
                    ...
                    /></Typography>
                    <Typography className="mb-16" component="div">Customization does not stop at CSS, you can use
                        composition to build custom components and give your app a unique
                        feel.
                        Below is an example using the <a
                            href="/api/input-base/"><code>{`InputBase`}</code></a> component, inspired by Google
                        Maps.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16" component="div"><code>{`Input`}</code> allows the provision
                        of <code>{`InputAdornment`}</code>.
                    ...
                    <Typography className="mb-16" component="div">Icons can be specified as prepended or
                        appended.</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                    ...
                    <Typography className="mb-16"
                                component="div"><code>{`TextField`}</code>, <code>{`FormControl`}</code> allow the
                        specification of <code>{`margin`}</code> to
                        alter the vertical spacing of inputs. Using
                        <code>{`none`}</code> (default) will not apply margins to the <code>{`FormControl`}</code>,
                        whereas <code>{`dense`}</code> and <code>{`normal`}</code> will
                        as well as alter
                    ...
                    <Typography className="mb-16" component="div">The input label &quot;shrink&quot; state isn&#39;t
                        always correct.
                        The input label is supposed to shrink as soon as the input is displaying something.
                        In some circumstances, we can&#39;t determine the &quot;shrink&quot; state (number input,
                        datetime input, Stripe input). You might notice an
                        overlap.</Typography>
                    <Typography className="mb-16" component="div"> src="/static/images/text-fields/shrink.png"
                        alt="shrink/></Typography>
                    <Typography className="mb-16" component="div">To workaround the issue, you can force
                        the &quot;shrink&quot; state of the label.</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div">You can use third-party libraries to format an input.
                        You have to provide a custom implementation of the <code>{`&lt;input&gt;`}</code> element with
                        the <code>{`inputComponent`}</code> property.
                    ...
                    <Typography className="mb-16" component="div">The following demo uses the <a
                        href="https://github.com/text-mask/text-mask">react-text-mask</a> and <a
                    ...
                    <Typography className="mb-16" component="div">In order for the text field to be accessible, <strong>the
                        input should be linked to the label and the helper
...
`}
                    ...
                    <ul>
                        <li>If you are using the <code>{`TextField`}</code> component, you just have to provide a
                            unique <code>{`id`}</code>.
                        </li>
...
`}
                    ...
                    <Typography className="mb-16" component="div">For more advanced use cases you might be able to take
                        advantage of:</Typography>
                    <ul>
                        <li><a href="https://github.com/erikras/redux-form-material-ui">redux-form-material-ui</a> A set
                            of wrapper components to facilitate using Material UI with
                            Redux Form.
                        </li>
                        <li><a href="https://github.com/stackworx/formik-material-ui">formik-material-ui</a> Bindings
                            for using Material-UI with formik.
                        </li>
                        <li><a href="https://github.com/Deadly0/final-form-material-ui">final-form-material-ui</a> A set
                            of wrapper components to facilitate using Material UI with
                            Final Form.
                        </li>
                    </ul>
