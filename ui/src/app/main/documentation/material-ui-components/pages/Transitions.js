        ...
        <FusePageSimple
            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="description">Transition helps make a UI expressive and easy to
                        use.</Typography>

                    <Typography className="mb-16" component="div">Material-UI provides a number of transitions that can
                        be used to introduce some basic
                        <a href="https://material.io/design/motion/">motion</a>
                        to your applications components.</Typography>
                    <Typography className="mb-16" component="div">To better support server rendering Material-UI
                        provides a <code>{`style`}</code> property
                        to the children of some transition components (Fade, Grow, Zoom, Slide).
                        The <code>{`style`}</code> property must be applied to the DOM for the animation to work as
                        expected.</Typography>
...
`}
                    ...
                    <Typography className="mb-16" component="div">Expand vertically from the top of the child element.
                        The <code>{`collapsedHeight`}</code> property can be used to set the minimum height when not
                        expanded.</Typography>
                    ...
                    <Typography className="mb-16" component="div">Expand outwards from the center of the child element,
                        while also fading in
                        from transparent to opaque.</Typography>
                    <Typography className="mb-16" component="div">The second example demonstrates how to change
                        the <code>{`transform-origin`}</code>, and conditionally applies
                    ...
                    <Typography className="mb-16" component="div">Slide in from the edge of the screen.
                        The <code>{`direction`}</code> property controls which edge of the screen the transition starts
                        from.</Typography>
                    <Typography className="mb-16" component="div">The Transition
                        component&#39;s <code>{`mountOnEnter`}</code> property prevents the child component from being
                        mounted
                        until <code>{`in`}</code> is <code>{`true`}</code>. This prevents the relatively positioned
                        component from scrolling into view
                        from it&#39;s off-screen position. Similarly the <code>{`unmountOnExit`}</code> property removes
                        the component
                    ...
                    <Typography className="mb-16" component="div">Expand outwards from the center of the child
                        element.</Typography>
                    <Typography className="mb-16" component="div">This example also demonstrates how to delay the enter
