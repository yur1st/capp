            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        the user, which can dramatically improve the performance
                        of your app. While you haven’t reduced the overall amount of code in your app, you’ve avoided
                        loading code that the user may never need, and reduced the
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        <br/>
                        <b>FuseSuspense</b> component is created for to avoid repetition
                        of <b>React.Suspense</b> component defaults, which is used in the theme layouts.
                        <br/>
                    ...
                    <Typography className="mt-32 mb-8" variant="h5">Code splitting the Redux reducers (Dynamically
                        loaded reducers)</Typography>
