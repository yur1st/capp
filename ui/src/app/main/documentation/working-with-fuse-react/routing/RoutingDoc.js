            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="p">
                        Fuse React routing system based on <a href="https://reacttraining.com/react-router/"
                                                              target="_blank" rel="noopener noreferrer"
                                                              className="font-bold">
                        react-router</a> and its package <a
                    ...
                    <Typography className="mb-16" component="p">
                        For example, have a look at the code below <FuseHighlight component="code"
                                                                                  className="language-bash">MailAppConfig.js</FuseHighlight>.
                        You can override
