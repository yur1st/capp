            ...
            content={
                <div className="p-24 max-w-2xl">
                    ...
                    <Typography className="mb-16" component="p">
                        ...
                        However, there are couple points that we want to put forward which might help you to keep Fuse
                        React updated:
                    </Typography>
                    ...
                    <Typography className="my-16" component="div">
                        <ol>
                            <li className="mb-16">
                                ...
                                to be inevitable and in those cases, try to keep the
                                modifications minimal.
                            </li>
                            <li className="mb-16">
                                Usually React and Material UI libraries do some breaking changes and force our hands to
                                change things. In those cases, it's always good to
                                check their official Changelogs to see what they did. Usually they provide clear
                                instructions and even helper tools to update your code.
                            </li>
                            <li className="mb-16">
                                Before starting your new project,
                                <a href="http://support.withinpixels.com/github" target="_blank"
                                   rel="noreferrer noopener" className="mx-4 font-bold">
                                    join our Github repo
                                </a>
                                , fork it and build your app on top of that fork. This way, in the future, you can
                                easily
                                merge or compare the changes from the main repo onto your fork. This will require
                                merging a lot of changes manually,
