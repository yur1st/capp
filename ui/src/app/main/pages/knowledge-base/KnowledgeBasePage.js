...
function KnowledgeBasePage() {
    ...
    return (
        <div className="w-full">
            ...
            <div
                className={clsx(classes.header, "flex flex-col items-center justify-center text-center p-16 sm:p-24 h-200 sm:h-360")}>
                    ...
                    >
                        {data.map((category) => (
                            <div className="w-full max-w-512 pb-24 md:w-1/2 md:p-16" key={category.id}>
                                <Card elevation={1}>
                                    <CardContent>
                                        <Typography className="font-medium px-16 pt-8"
                                                    color="textSecondary">{category.title}</Typography>
                                        <List component="nav">
                                        ...
                                        <Button className="normal-case w-full justify-start" color="secondary">See all
                                            articles ({category.articlesCount})</Button>
                                    </CardContent>
                                </Card>
                            </div>
                        ))}
