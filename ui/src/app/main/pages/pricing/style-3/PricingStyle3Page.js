                        ...
                        <div className="w-full max-w-320 sm:w-1/3 p-12">
                            <Card className="relative">
                                    ...
                                    <div className={clsx(classes.price, "flex items-end justify-center py-16 px-32")}>
                                        <div className="flex justify-center">
                                            ...
                                            <Typography color="inherit"
                                                        className="text-32 ml-4 mr-8 font-light leading-none">29</Typography>
                                        </div>
                                        <Typography color="inherit">
                                            monthly per user
                                        </Typography>
                                ...
                                <div className="flex flex-col items-center justify-center pb-32 px-32">
                                    <Button variant="contained" color="secondary" className="w-full">GET STARTED
                                        FREE</Button>
                                ...
                                <CardContent className="text-center p-0">
                                    ...
                                    <div className={clsx(classes.price, "flex items-end justify-center py-16 px-32")}>
                                        <div className="flex justify-center">
                                            <Typography color="inherit" className="font-medium">$</Typography>
                                            <Typography color="inherit"
                                                        className="text-32 ml-4 mr-8 font-light leading-none">59</Typography>
                                        </div>
                                        <Typography color="inherit">
                                            monthly per user
                                        </Typography>
